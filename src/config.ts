...
export const siteConfig: SiteConfig = {
	title: "Yukilain",
	subtitle: "blog",
	siteURL: "https://yukilain.com/", // 请替换为你的站点URL，以斜杠结尾
	...
	bangumi: {
		userId: "yukilain", // 在此处设置你的Bangumi用户ID，可以设置为 "sai" 测试
	},
	...
	banner: {
		...
		src: {
			desktop: [
				"/assets/desktop-banner/banner1.jpg",
				"/assets/desktop-banner/banner2.jpg",
				"/assets/desktop-banner/banner3.jpg",
				"/assets/desktop-banner/banner4.png",
				"/assets/desktop-banner/banner6.jpg",
				"/assets/desktop-banner/banner7.jpg",
			], // 桌面横幅图片
			mobile: [
		...
		homeText: {
			...
			title: "Yukilain", // 主页横幅主标题

			subtitle: [
				"The world is not beautiful, Therefore it is.",
				"逃げちゃダメだ、逃げちゃダメだ、逃げちゃダメだ",
				"美しく最后を饰りつける暇があるなら、最后まで、美しく生きようじゃねーか",
				"この世界に、何かを守ろうと願えば、必ずその為に戦わねばなりません",
	...
	links: [
		...
		// 支持自定义导航栏链接,并且支持多级菜单,3.1版本新加
		{
			...
			children: [
				{
					name: "GitHub",
					url: "https://github.com/Yukilain",
					external: true,
					icon: "fa6-brands:github",
				},
				{
					name: "Bilibili",
					url: "https://space.bilibili.com/294438150",
					external: true,
				...
				// {
				// 	name: "Bangumi",
				// 	url: "https://bgm.tv/user/yukilain",
				// 	external: true,
				// 	icon: "fa6-solid:b",
				// },
				// {
...
export const commentConfig: CommentConfig = {
	...
	twikoo: {
		envId: "https://blog-tan-three-79.vercel.app/",
...
export const announcementConfig: AnnouncementConfig = {
	...
	content: "欢迎来到我的博客世界，希望我们成为赛博好友~", // 公告内容
